    ...
    >
      ...
      >
        ...
        <p className="mb-10 font-serif text-[15px] leading-[1.75] text-[#4a4540] md:text-[16px]">
          ...
          коммуникации — скворечником. Внутреннее пространство объекта
          превращается в метафору среды, где накопленная агрессия не исчезает, а
          оседает, свивается и начинает формировать собственную материальную
          экосистему.
        </p>
